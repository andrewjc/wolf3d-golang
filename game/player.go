...
func (p *Player) getReward() float32 {
    ...
    p.game.player1Controller.distanceStack = append(p.game.player1Controller.distanceStack, eucDistance)
    ...
    return float32(logAverage) * bonuses
}
